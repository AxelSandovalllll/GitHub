...
public class ImagePanel extends JPanel {
	...
	// From
	// http://stackoverflow.com/questions/6575578/convert-a-graphics2d-to-an-image-or-bufferedimage?rq=1
	// and
	// http://stackoverflow.com/questions/5853879/swing-obtain-image-of-jframe/5853992#5853992
	...
	// private class MouseInteractionListener implements MouseListener,
	// MouseMotionListener
	// {
	...
	public void mouseDragged(MouseEvent e) {
		...
		if (expandShow) {
			...
			if ((mousePos.x - span < 0) || mousePos.x + span >= getWidth() || mousePos.y - span < 0
					|| mousePos.y + span >= getHeight()) {
				return;
			}
	...
	public void mouseClicked(MouseEvent e) {
		...
		// if (pixelSample == null)
		// {
		// pixelSample = new BufferedImage(getWidth(), getHeight(),
